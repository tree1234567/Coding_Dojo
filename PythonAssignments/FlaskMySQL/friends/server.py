...
def show(friend_id):
    ...
    # query = "SELECT * FROM friends WHERE id = '" friend_id + "'" WE DONT NEED TO DO THIS WITH query_db()
    

    query = "SELECT * FROM friends WHERE id = :specific_id" #acts as place holder for the friend_id arguement that is passed!
